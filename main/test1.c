...
#define WIFI_SSID "Telecom-Admin"
#define WIFI_PASSWORD "telecom@vnpt#"
...
static esp_err_t http_post_task(void *pvParameters)
{
  char data_buf[250]; // Adjust size as needed
  ...
  esp_http_client_set_header(client, "Content-Length", strlen(data_buf));
